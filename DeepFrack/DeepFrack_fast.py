...
def GetNum(FilePath):
    ...
    num = int(filename[len("Lenet_layer"):-5])
    return num
...
folder_path = '/workspace/Aim/problemCNN/Lenet'  # Folder containing all the layers
BenchMrkrLog_folder = '/workspace/Aim/benchmarks/benchmarks_lenet'
CheatSheet = '/workspace/Aim/DeepFrack/CheatSheet.json'
OutputImgFile = '/workspace/Aim/Results_Final/Lenet/comparison.jpg'
LogFile = '/workspace/Aim/Results_Final/Lenet/deepfrack-stats-file.txt'
WeightLevel_name = 'PEWeightRegs'
WeightLevel_size = 1*512
InputLevel_name = 'GLB'
InputLevel_size = 2048*2
OutputLevel_name = 'GLB'
OutputLevel_size = 2048*2
